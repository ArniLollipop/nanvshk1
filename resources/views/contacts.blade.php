...
@section('content') 
    ...
    <div class="boxed_wrapper">
        ...
        <section class="google-map-section">
            <div class="map-inner img--change">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 info-column">
                        <div class="info-inner">
                            <div class="sec-title p_relative d_block mb_40">
                                <h5 class="d_block fs_17 lh_20 fw_sbold uppercase mb_17 text--resize">@lang('main.contacts.info1')</h5>
                                <h3 class="d_block fs_30 lh_40 fw_bold text--resize">@lang('main.contacts.info2')</h3>
                            </div>
                            <ul class="info-list clearfix">
                                <li class="p_relative d_block pl_100 pb_18 mb_25">
                                    ...
                                    <h4 class="d_block fs_20 lh_30 fw_sbold mb_7 text--resize">@lang('main.contacts.adr')</h4>
                                    <p class="font_family_poppins text--resize">@lang('main.about.contactinfo')</p>
                                </li>
                                <li class="p_relative d_block pl_100 pb_18 mb_25">
                                    <div class="icon-box p_absolute l_0 t_0 d_iblock w_80 h_80 lh_80 b_radius_50 text-center fs_45 z_1 mb_25 tran_5">
                                    ...
                                    <h4 class="d_block fs_20 lh_30 fw_sbold mb_7 text--resize">Email</h4>
                                    <p class="font_family_poppins text--resize"><a href="mailto:nanvshk@gmail.com"  aria-label="Написать на почту nanvshk@gmail.com">nanvshk@gmail.com</a><br /></p>
                                </li>
                                <li class="p_relative d_block pl_100 pb_18">
                                    ...
                                    <h4 class="d_block fs_20 lh_30 fw_sbold mb_7 text--resize">@lang('main.contacts.adr1')</h4>
                                    <p class="font_family_poppins text--resize"><a href="tel:77717091125"  aria-label="Позвонить на +7 (771) 709-11-25">+7 (771) 709-11-25</a><br /></p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-12 col-sm-12 form-column">
                        <div class="form-inner p_relative ml_40 pt_45 pr_50 pb_50 pl_50 b_radius_10 b_shadow_6">
                            <div class="text p_relative d_block mb_35">
                                <h3 class="d_block fs_30 lh_40 fw_bold text--resize">@lang('main.contacts.adr2')</h3>
                            </div>
                              ...
                              {{ csrf_field() }}
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                                        <button class="theme-btn theme-btn-eight" type="submit" name="submit-form" aria-label="@lang('main.contacts.send')">@lang('main.contacts.send')<i class="icon-4"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
